@cic_parent_account
Feature: Is the CIC Parent Account /par/acc/editpaypaye page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from CIC Parent Account /par/acc/editpaypaye page is correctly displayed
...
Scenario: CIC Parent Account page /par/acc/editpaypaye with action NEXT rules are ordered correctly
    Given the user has visited "CIC Parent Account" website
    And the user is on page "/par/acc/editpaypaye"
