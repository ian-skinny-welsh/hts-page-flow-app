@cic_parent_account
Feature: Is the CIC Parent Account /par/app/stoptaxcreditswarning page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from CIC Parent Account /par/app/stoptaxcreditswarning page is correctly displayed
