Feature: Is the CIC Parent Account /par/app/childsname page navigation correct?
...
Scenario: CIC Parent Account page /par/app/childsname with action NEXT rules are ordered correctly
