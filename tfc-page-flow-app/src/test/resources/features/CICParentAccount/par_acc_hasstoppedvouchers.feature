@cic_parent_account
Feature: Is the CIC Parent Account /par/acc/hasstoppedvouchers page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from CIC Parent Account /par/acc/hasstoppedvouchers page is correctly displayed
