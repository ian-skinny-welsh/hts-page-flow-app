@cic_parent_account
Feature: Is the CIC Parent Account /par/app/taxcreditswarning page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from CIC Parent Account /par/app/taxcreditswarning page is correctly displayed
