@cic_parent_account
Feature: Is the CIC Parent Account /par/app/continueaddingtwoyearold page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from CIC Parent Account /par/app/continueaddingtwoyearold page is correctly displayed
