@cic_parent_reg
Feature: Is the CIC Parent Reg /par/app/adoptionpaywarningpartner page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from CIC Parent Reg /par/app/adoptionpaywarningpartner page is correctly displayed
