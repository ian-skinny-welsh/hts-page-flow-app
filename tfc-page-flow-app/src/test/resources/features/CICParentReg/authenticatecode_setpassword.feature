@cic_parent_reg
Feature: Is the CIC Parent Reg /authenticatecode/setpassword page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from CIC Parent Reg /authenticatecode/setpassword page is correctly displayed
