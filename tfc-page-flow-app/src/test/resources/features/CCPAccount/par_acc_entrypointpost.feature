Feature: Is the CCP Account /par/acc/entrypointpost page navigation correct?
...
Scenario: CCP Account page /par/acc/entrypointpost with action NEXT rules are ordered correctly
