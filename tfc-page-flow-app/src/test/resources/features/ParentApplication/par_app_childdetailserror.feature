@parent_application
Feature: Is the Parent Application /par/app/childdetailserror page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from Parent Application /par/app/childdetailserror page is correctly displayed
