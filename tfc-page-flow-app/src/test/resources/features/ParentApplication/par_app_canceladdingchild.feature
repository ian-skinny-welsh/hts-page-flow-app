@parent_application
Feature: Is the Parent Application /par/app/canceladdingchild page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from Parent Application /par/app/canceladdingchild page is correctly displayed
