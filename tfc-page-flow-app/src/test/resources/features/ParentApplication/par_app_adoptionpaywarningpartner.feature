@parent_application
Feature: Is the Parent Application /par/app/adoptionpaywarningpartner page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from Parent Application /par/app/adoptionpaywarningpartner page is correctly displayed
...
Scenario: Parent Application page /par/app/adoptionpaywarningpartner with action NEXT rules are ordered correctly
    Given the user has visited "Parent Application" website
    And the user is on page "/par/app/adoptionpaywarningpartner"
