@parent_account
Feature: Is the Parent Account /par/app/maternitypaywarning page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from Parent Account /par/app/maternitypaywarning page is correctly displayed
...
Scenario: Parent Account page /par/app/maternitypaywarning with action NEXT rules are ordered correctly
    Given the user has visited "Parent Account" website
    And the user is on page "/par/app/maternitypaywarning"
