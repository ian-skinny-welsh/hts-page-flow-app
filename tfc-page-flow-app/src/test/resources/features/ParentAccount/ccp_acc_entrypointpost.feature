Feature: Is the Parent Account /ccp/acc/entrypointpost page navigation correct?
...
Scenario: Parent Account page /ccp/acc/entrypointpost with action NEXT rules are ordered correctly
