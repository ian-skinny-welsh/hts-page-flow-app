@parent_account
Feature: Is the Parent Account /par/app/apprenticeminpay page navigation correct?
  Is the correct page returned

Scenario Outline: The next page from Parent Account /par/app/apprenticeminpay page is correctly displayed
